...
class Robot_Population:
    ...
    def save_population_state(self):
        filename = '{}_random_robots_12_04_2023.pkl'.format(self.evaluations)
        data_to_save = {
        'population': self.population, 
        'fitness_raw': self.fitness_raw,
        'fitness_arr': self.fitness_arr, 
        'fitness_ind': self.fitness_ind }
...
def Main():
    pop1 = Robot_Population(pop_size=20,
                            simulation_time= 1)
